...
* Programm information in a seperate device.
* Remaining time the current programm in a seperate device.
* Progress information as text in a seperate device.
* State off the door in a seperate device.
* Power state in a seperate device.
* Oven temperature in a seperate device.
